...
<p>According to the <a href="https://en.wikipedia.org/wiki/H-index" target="_blank" previewlistener="true">definition of h-index on Wikipedia</a>: The h-index is defined as the maximum value of <code>h</code> such that the given researcher has published at least <code>h</code> papers that have each been cited at least <code>h</code> times.</p>
